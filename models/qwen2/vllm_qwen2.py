...
class Qwen2DecoderLayer(nn.Module):
    ...
    def __init__(
        ...
        self.self_attn = Qwen2MLAttention(
...
class Qwen2MLAForCausalLM(nn.Module, SupportsLoRA, SupportsPP):
    ...
    def __init__(self, *, vllm_config: VllmConfig, prefix: str = ""):
        ...
        self.model = Qwen2MLAModel(vllm_config=vllm_config,
